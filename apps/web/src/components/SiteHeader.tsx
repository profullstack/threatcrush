  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 border-b border-tc-border/50 bg-tc-darker/80 backdrop-blur-md">
        <div className="mx-auto flex h-[calc(var(--tc-header-h)-1px)] max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="hidden md:flex items-center gap-5 text-sm text-tc-text-dim">
            ...
            <a href="/hire" className="hover:text-tc-green transition-colors">Hire Us</a>
        ...
        {mobileNavOpen && (
          <div className="border-t border-tc-border/50 bg-tc-darker/95 px-4 py-4 md:hidden">
            <div className="flex flex-col gap-3 text-sm text-tc-text-dim">
              ...
              <a href="/read/ctem-guide" className="text-tc-green transition-colors" onClick={() => setMobileNavOpen(false)}>📄 Free CTEM Guide</a>
              ...
              <a href="/hire" className="hover:text-tc-green transition-colors" onClick={() => setMobileNavOpen(false)}>Hire Us</a>
